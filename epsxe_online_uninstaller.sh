...
#ePSXe Libs x86_64 Remove
   sudo apt remove -y libncurses5 libncurses5:i386 libsdl1.2debian libsdl1.2debian:i386 libsdl-ttf2.0-0 libsdl-ttf2.0-0:i386 libgssapi3-heimdal libgssapi3-heimdal:i386 libssl1.0.0 libssl1.0.0:i386
...
#ePSXe x86_64 Remove
   ...
   sudo apt remove -y libncurses5 libsdl1.2debian libsdl-ttf2.0-0 libgssapi3-heimdal libssl1.0.0
